             ...
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-4 sm:gap-6">
                 <div className="flex items-center gap-4">
                   <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center shadow-2xl bg-white">
                     <img src="/src/assets/logo.png" alt="Elite Advisers" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
                   </div>
                   <div>
                     <p className="text-xs sm:text-sm font-medium text-gray-500">Compliance Advisor Panel</p>
                     <h1 className="brand-font text-2xl sm:text-3xl font-black bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent tracking-widest">
                ...
                <div className="hidden md:flex items-center gap-4 pl-8 border-l border-gray-200">
                  ...
                  />
                  <div>
                    <p className="font-bold text-gray-900 text-lg">{profile.name || "Compliance Advisor"}</p>
                    <p className="text-sm text-gray-500 flex items-center gap-2">
                      <Clock className="w-4 h-4" />
                      {formatTime(clock)}
                    </p>
                    {profile.bio && <p className="text-xs text-indigo-600 mt-1 font-medium">{profile.bio}</p>}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-6 py-3.5 bg-gradient-to-r from-red-500 to-rose-600 text-white font-bold rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 shadow-xl"
                >
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 space-y-8 sm:space-y-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                <div className="lg:col-span-2 space-y-6">
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                    ...
                    <div className="flex-1 space-y-4 w-full sm:w-auto">
                      <div>
                        ...
                        <input
                          className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 text-base sm:text-lg font-medium"
                          value={profile.name}
                      ...
                      <div>
                        ...
                        <input
                          className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500"
                          value={profile.photo}
                  ...
                  <div>
                    ...
                    <textarea
                      rows={4}
                      className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 resize-none"
                      value={profile.bio}
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="flex items-center gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 shadow-xl"
                    >
                      <Save className="w-5 h-5 sm:w-6 sm:h-6" /> Save Profile
                    </button>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-6 sm:p-8 border border-indigo-100">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-6">Quick Stats</h3>
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 overflow-hidden">
            <div className="p-4 sm:p-8 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
              <h2 className="text-2xl sm:text-3xl font-bold flex items-center gap-3 sm:gap-4">
             ...
             <div className="divide-y divide-gray-100">
               {problems.filter(p => p.status !== "closed").length > 0 ? problems.filter(p => p.status !== "closed").map((p) => (
                <div key={p.problemId} className="p-4 sm:p-8 hover:bg-gray-50/70 transition-all duration-300">
                    ...
                    <div className="flex-1 space-y-4 sm:space-y-5">
                      <div>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2 sm:gap-3 text-sm">
                          <span className="px-3 sm:px-4 py-2 bg-indigo-100 text-indigo-700 rounded-xl font-medium">
                            {p.userName} • {p.userEmail}
                          </span>
                          {p.assignedAdmin && (
                            <span className="px-3 sm:px-4 py-2 bg-emerald-100 text-emerald-700 rounded-xl font-medium">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 pt-4 border-t border-gray-200">
                        <div>
                          <label className="text-sm font-medium text-gray-600 flex items-center gap-2">
                            <MessageSquare className="w-4 h-4 sm:w-5 sm:h-5" /> Message to Client
                          </label>
                          <textarea
                            rows={3}
                            className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 resize-none"
                        ...
                        <div className="space-y-4">
                          <div>
                            <label className="text-sm font-medium text-gray-600 flex items-center gap-2">
                              <Calendar className="w-4 h-4 sm:w-5 sm:h-5" /> Schedule Meetup
                            </label>
                            <input
                              type="date"
                              className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500"
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div>
                              ...
                              <select
                                ...
                                className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 font-medium"
                              >
                      ...
                      <div className="flex justify-end pt-4">
                        <button
                          ...
                          className="flex items-center gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 shadow-xl w-full lg:w-auto"
                        >
                          <Save className="w-5 h-5 sm:w-6 sm:h-6" /> Update Query
                        </button>
                      </div>
                    </div>
                ...
                <div className="text-center py-16 sm:py-24">
                  <AlertCircle className="w-20 h-20 sm:w-28 sm:h-28 text-gray-300 mx-auto mb-6" />
          ...
          {/* Add Article */}
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-4 sm:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3 sm:gap-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    className="mt-2 w-full px-4 sm:px-5 py-3 sm:py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 text-base sm:text-lg"
                    value={article.title}
              ...
              <div>
                ...
                <div className="mt-6 text-right">
                  <button
                    ...
                    className="inline-flex items-center gap-3 px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold text-base sm:text-xl rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 shadow-xl"
                  >
                    <Plus className="w-6 h-6 sm:w-7 sm:h-7" /> Publish to Library
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {problems.filter(p => p.status === "closed").length > 0 ? (
                problems.filter(p => p.status === "closed").map((p) => (
                  <div key={p.problemId} className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4 sm:p-6 border border-emerald-100">
                ...
                <p className="col-span-full text-center text-lg sm:text-xl text-gray-500 py-12 sm:py-16">No closed cases yet. Keep up the great work!</p>
              )}
            </div>
          </div>
        </main>
