                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1 space-y-4">
                      <div>
                        ...
                        <input
                          className="mt-2 w-full px-5 py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 text-lg font-medium"
                          value={profile.name}
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                onChange={(e) =>
                                  setProblems((prev) =>
                                    prev.map((pr) =>
                                      pr.problemId === p.problemId ? { ...pr, adminMessage: e.target.value } : pr
                                    )
                                  )
                                }
                              />
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <input
                                  type="date"
                                  className="mt-2 w-full px-5 py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500"
                                  value={p.meetupDate ? new Date(p.meetupDate).toISOString().split('T')[0] : ""}
                                  onChange={(e) =>
                                    setProblems((prev) =>
                                      prev.map((pr) =>
                                        pr.problemId === p.problemId ? { ...pr, meetupDate: e.target.value || null } : pr
                                      )
                                    )
                                  }
                                />
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <select
                                    ...
                                    onChange={(e) =>
                                      setProblems((prev) =>
                                        prev.map((pr) =>
                                          pr.problemId === p.problemId ? { ...pr, status: e.target.value } : pr
                                        )
                                      )
                                    }
                                ...
                                <div>
                                  ...
                                  <select
                                    value={p.assignTo || p.assignedAdmin?._id || ""}
                                    onChange={(e) =>
                                      setProblems((prev) =>
                                        prev.map((pr) =>
                                          pr.problemId === p.problemId
                                            ? { ...pr, assignTo: e.target.value || null }
                                            : pr
                                        )
                                      )
                                    }
                            ...
                            <button
                              onClick={() =>
                                updateProblem(p.problemId, {
                                  adminMessage: p.adminMessage?.trim(),
                                  status: p.status,
                                  assignTo: p.assignTo,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    className="mt-2 w-full px-5 py-4 border border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 text-lg"
                    value={article.title}
              ...
              <div>
                ...
                <div className="mt-6 text-right">
                  <button
                    ...
                    className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold text-xl rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 shadow-xl"
                  >
                    <Plus className="w-7 h-7" /> Publish to Library
                  </button>
                </div>
              </div>
            </div>
